...
**Objective**: Verify that creating a MaaSAuthPolicy in a tenant namespace causes the maas-controller to generate a corresponding Kuadrant AuthPolicy attached to the shared Gateway.

...
**Objective**: Verify that the maas-controller automatically discovers and begins reconciling a namespace when the `maas.opendatahub.io/tenant` label is added.
